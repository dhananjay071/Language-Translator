    ...
    <div class='pad1'>
        ...
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>472/486</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>98/109</span>
            </div>
...
<a name='L487'></a><a href='#L487'>487</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">1x</span>
...
&nbsp;
  const result: Parsed = {
    ...
    path: (url.pathname<span class="branch-0 cbranch-no" title="branch not covered" > || "")</span> + (url.search || ""),
...
&nbsp;
  parsed() {
    ...
    this._parsed.protocol = this._parsed.protocol<span class="branch-0 cbranch-no" title="branch not covered" > || defaults.protocol</span>
    return this._parsed
  }
&nbsp;
  getExtendedPath() {
    let href = this.getPath()
    href += this.getQueryString() ? "?" + this.getQueryString() <span class="branch-0 cbranch-no" title="branch not covered" >: ""</span>
    href += this.getHash() ? "#" + this.getHash() <span class="branch-0 cbranch-no" title="branch not covered" >: ""</span>
    return href
  }
&nbsp;
...
&nbsp;
  port(num: number | string | null) {
    if (this.getProtocol() === "file") <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
...
&nbsp;
  query(mergeObject: Dict&lt;string | number | null&gt;) {
    ...
    for (const [k, v] of Object.entries(mergeObject)) {
      if (v === null) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
...
&nbsp;
  encode(str: string) {
    ...
    } <span class="branch-0 cbranch-no" title="branch not covered" >catch (ex) {</span>
<span class="cstat-no" title="statement not covered" >      return new URLSearchParams({"": str}).toString().slice(1)</span>
<span class="cstat-no" title="statement not covered" >    }</span>
  }
&nbsp;
  decode(str: string) {
...
<span class="cstat-no" title="statement not covered" >    const val = new URLSearchParams(`=${str}`).get("")</span>
<span class="cstat-no" title="statement not covered" >    if (!val &amp;&amp; val !== "") {</span>
<span class="cstat-no" title="statement not covered" >      throw new Error(`decode() input could not be decoded: ${str}`)</span>
<span class="cstat-no" title="statement not covered" >    }</span>
...
const portString = function (o: UrlGrey): string {
  ...
  if (port<span class="branch-0 cbranch-no" title="branch not covered" > || port === 0)</span> return `${port}` <span class="branch-0 cbranch-no" title="branch not covered" ></span>
