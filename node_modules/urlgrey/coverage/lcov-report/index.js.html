    ...
    <div class='pad1'>
        ...
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>451/468</span>
            </div>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var url = require("fast-url-parser");
...
&nbsp;
    ...
    path: (parsed.pathname <span class="branch-0 cbranch-no" title="branch not covered" >|| "")</span> + (parsed.search || ""),
    href: href,
...
var getDefaults = function () {
  ...
  if (isBrowser) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
...
&nbsp;
if (!Array.isArray) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
...
var argsArray = function (obj) {
  if (!obj) <span class="branch-0 cbranch-no" title="branch not covered" >{ return []; }</span>
  if (Array.isArray(obj)) <span class="branch-0 cbranch-no" title="branch not covered" >{ return obj.slice(); }</span>
  var args = [];
...
var UrlGrey = function (url) {
  if (!url &amp;&amp; isBrowser) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
...
UrlGrey.prototype.extendedPath = function (url) {
  if (url) {
    ...
    var href = this.path();
    href += this.queryString() ? '?' + this.queryString() <span class="branch-0 cbranch-no" title="branch not covered" >: '';</span>
    href += this.hash() ? '#' + this.hash() <span class="branch-0 cbranch-no" title="branch not covered" >: '';</span>
    return href;
  }
};
&nbsp;
...
&nbsp;
  // setter
  if (num) {
    if (this.protocol() === 'file') <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
...
<span class="branch-0 cbranch-no" title="branch not covered" >      default: return null;</span>
    }
  }
...
UrlGrey.prototype.query = function (mergeObject) {
  if (arguments.length === 0) {
    ...
    objectEach(mergeObject, function (v, k) {
      if (v === null || v === false) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
